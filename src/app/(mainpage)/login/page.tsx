...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 px-4">
      <h1 className="text-5xl font-bold text-sky-600 mb-8">Pastor</h1>
      ...
      <p className="mt-6 text-center text-gray-700 dark:text-gray-300">
        Está aqui para fazer uma doação?{" "}
        <Link href="/logindoador" className="text-sky-600 hover:underline">
          Clique aqui
        </Link>
      </p>
    </div>

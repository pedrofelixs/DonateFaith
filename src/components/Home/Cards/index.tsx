...
const Cards = () => {
  return (
    <section className="bg-gray-100 dark:bg-gray-700" id="donate-section">
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md pb-5">
        <div className="text-center mb-14 py-10">
          <p className="dark:text-sky-200 text-sky-600 font-normal mb-9 tracking-[0.8rem] uppercase">
            Funcionalidades
          </p>
          <h2 className="text-3xl lg:text-5xl font-semibold text-gray-900 dark:text-white lg:max-w-60% mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-y-15 gap-x-5 mt-15">
          {FeaturesData.map((items, i) => (
            <div
              className="p-8 relative rounded-3xl bg-white shadow-md dark:bg-gradient-to-b dark:from-gray-600 dark:to-gray-800"
              key={i}
            >
              ...
              <h3 className="text-2xl text-gray-900 dark:text-white font-semibold text-center mt-16">
                {items.heading}
              </h3>
              <p className="text-lg font-normal text-gray-600 dark:text-white/50 text-center mt-2">
                {items.subheading}
              </p>
